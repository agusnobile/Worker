...
using OnboardingServicioNotificaciones.Domain.Dtos;
using OnboardingServicioNotificaciones.Domain.Entities;
using MediatR;
...
namespace OnboardingServicioNotificaciones.Application.UseCase.V1.PersonOperation.Queries.GetList;
